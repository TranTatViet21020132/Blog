...
//fetch user from db but not curent user
    ...
    <div class="container dashboard__container">
        ...
        <aside>
            <ul>
                ...
                <li><a href="index.php"><i class="uil uil-postcard"></i></i>
                    <h5>Manage Posts</h5>
                </a></li>
                ...
                <li><a href="manage-users.php" class="active"><i class="uil uil-users-alt"></i></i>
                    <h5>Manage Users</h5>
                </a></li>
